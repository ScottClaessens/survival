...
```{r}
(1 / hypothesis(b3.3, "inv_logit_scaled(intercept + Condition) - inv_logit_scaled(intercept) = 0", seed = 2113)$hypothesis$Evid.Ratio) %>% round(2)
```
...
```{r}
(1 / hypothesis(b3.4, "inv_logit_scaled(intercept + Condition) - inv_logit_scaled(intercept) = 0", seed = 2113)$hypothesis$Evid.Ratio) %>% round(2)
```
...
```{r}
(1 / hypothesis(b3.5, "inv_logit_scaled(intercept + Condition) - inv_logit_scaled(intercept) = 0", seed = 2113)$hypothesis$Evid.Ratio) %>% round(2)
```
...
Finally, `bayes_R2()` tells us that this model explains around 24% of the variance in the outcome.
...
```{r}
(1 / hypothesis(b3.6, "inv_logit_scaled(intercept + Condition) - inv_logit_scaled(intercept) = 0", seed = 2113)$hypothesis$Evid.Ratio) %>% round(2)
```
