...
g1 <-
  ...
  geom_text(aes(x = Inf, y = Inf, hjust = 1, vjust = 1.5, label = "BF = 6.00")) +
  ylim(0,1) + 
...
ggsave('figures/fig1.1.pdf', width = 8, height = 4,
...
g1 <-
  ...
  geom_ribbon(aes(ymin = pi.025, ymax = pi.975), alpha = 0.2) +
  geom_ribbon(aes(ymin = pi.250, ymax = pi.750), alpha = 0.2) +
  geom_text(aes(x = Inf, y = Inf, hjust = 1, vjust = 1.5, label = "BF = 11.86")) +
  ylim(0,1) + 
...
# print and save to working directory
ggsave('figures/fig1.2.pdf', width = 8, height = 4,
       plot = grid.arrange(g1, g2, nrow = 1, widths = c(1, 2)))
```
...
g1 <-
  ...
  geom_ribbon(aes(ymin = pi.025, ymax = pi.975), alpha = 0.2) +
  geom_ribbon(aes(ymin = pi.250, ymax = pi.750), alpha = 0.2) +
  geom_text(aes(x = Inf, y = Inf, hjust = 1, vjust = 1.5, label = "BF = 3.28")) +
  ylim(0,1) + 
...
# print and save to working directory
ggsave('figures/fig1.3.pdf', width = 8, height = 4,
       plot = grid.arrange(g1, g2, nrow = 1, widths = c(1, 2)))
```
...
g1 <-
  ...
  geom_ribbon(aes(ymin = pi.025, ymax = pi.975), alpha = 0.2) +
  geom_ribbon(aes(ymin = pi.250, ymax = pi.750), alpha = 0.2) +
  geom_text(aes(x = Inf, y = Inf, hjust = 1, vjust = 1.5, label = "BF = 2.79")) +
  ylim(0,1) + 
  labs(y = 'Median predicted probability\n of not fulfilling requests when able',
       x = 'Condition') +
  theme_classic() +
  theme(panel.grid.major.x = element_blank())
...
# print and save to working directory
ggsave('figures/fig1.4.pdf', width = 8, height = 4,
       plot = grid.arrange(g1, g2, nrow = 1, widths = c(1, 2)))
```
